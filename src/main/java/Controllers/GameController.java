...
import Models.Artisan.ArtisanType;
import Models.Communication.FriendShip;
import Models.Communication.Gift;
...
//        TODO: check for usage
    ...
    public GameMessage walk(Position end) {
        ...
        if(map.getTile(end).getObject() != null && map.getTile(end).getBuilding() != null && !(map.getTile(end).getBuilding() instanceof GreenHouse)) {
